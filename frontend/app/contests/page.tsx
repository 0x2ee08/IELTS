                                        ...
                                        <td>
                                            {contest.registered ? (
                                                <Link href={`/contests/${contest.id}`}>
                                                    <button className="text-blue-600 hover:underline cursor-pointer">Join</button>
                                                </Link>
                                            ) : (
                                                <button onClick={() => handleRegister(contest.id)} className="text-blue-600 hover:underline cursor-pointer">Register</button>
                                            )}
                                        </td>
                                    </tr>
                                ))}
                            ...
                            <tbody>
                                {upcomingContest.map((contest, cnt) => (
                                    <tr key={contest.id} className={cnt % 2 === 0 ? "even-row" : "odd-row"}>
                                        ...
                                        <td>
                                            {contest.registered ? (
                                                <div className='text-gray-500'>Already registered</div>
                                            ) : (
                                                <button onClick={() => handleRegister(contest.id)} className="text-blue-600 hover:underline cursor-pointer">Register</button>
                                            )}
                                        </td>
